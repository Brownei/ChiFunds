  ...
  return (
    <main>
      ...
      <div className="flex flex-col justify-center items-center gap-[23px] text-center h-screen py-[300px]">
        ...
        <Link href={'/register'} className="bg-darkBrown font-PoppinsRegular px-24 py-3 rounded-[40px] text-white hover:bg-littleDarkBrown duration-200 transition-all cursor-pointer" >
          Get Started
        </Link>
      </div>
    </main>
