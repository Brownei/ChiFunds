...
const Modal = () => {
  ...
  const formatCurrency = (value: string) => {
    const number = parseFloat(value.replace(/,/g, '')); // Remove commas
      ...
      {errorSection === 'rubbish' ? (
        <DialogContent>
          <DialogHeader className='flex flex-col font-PoppinsRegular justify-center items-center'>
            <Image width={700} height={700} src={'/willem-dafoe-looking-up.avif'} alt='Who is the problem' />
        ...
        <DialogContent >
          <DialogHeader className='flex flex-col font-PoppinsRegular justify-center items-center'>
            <Image width={700} height={700} src={'/trust-me.png'} alt='I will kill you!' />
        ...
        <DialogContent>
          <DialogHeader className='flex flex-col font-PoppinsRegular justify-center items-center'>
            <Image width={700} height={700} src={'/ozons-salute.avif'} alt='Who is the problem' />
